  ...
  const gerarOrderPayload = (pedido: Pedido) => {
    ...
    const items = rawItens.map((it: any) => {
      ...
      return {
        ...
        total: totalPriceFmt,
        total_item: totalPriceFmt,
        item_total: totalPriceFmt,
        totalItem: totalPriceFmt,
        itemTotal: totalPriceFmt,
        totalPrice: totalPriceFmt,
        total_price: totalPriceFmt,
        priceTotal: totalPriceFmt,
        price_total: totalPriceFmt,
        precoTotal: totalPriceFmt,
        preco_total: totalPriceFmt,
        totalPreco: totalPriceFmt,
        total_preco: totalPriceFmt,
        valorTotal: totalPriceFmt,
        valor_total: totalPriceFmt,
        totalValor: totalPriceFmt,
        total_valor: totalPriceFmt,
        valorItem: totalPriceFmt,
        valor_item: totalPriceFmt,
        itemValor: totalPriceFmt,
        item_valor: totalPriceFmt,
        subtotal: totalPriceFmt,

        price: unitPriceFmt,
        preco: unitPriceFmt,
        valor: unitPriceFmt,
        val: unitPriceFmt,
        unitPrice: unitPriceFmt,
        unit_price: unitPriceFmt,
        priceUnit: unitPriceFmt,
        price_unit: unitPriceFmt,
        precoUnitario: unitPriceFmt,
        preco_unitario: unitPriceFmt,
        valorUnitario: unitPriceFmt,
        valor_unitario: unitPriceFmt,
    ...
    const deliveryFeeFmt = deliveryFeeNum.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    const discountFmt = discountNum.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    const pedidoAny = pedido as any;
    const paymentMethodStr = pedidoAny.formaPagamento || pedidoAny.paymentMethod || pedidoAny.forma_pagamento || pedidoAny.pgto || 'Não informado';
    const changeForNum = Number(pedidoAny.trocoPara || pedidoAny.changeFor || pedidoAny.troco_para || pedidoAny.troco || 0);
    const changeForFmt = changeForNum.toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    ...
    return {
      ...
      deliveryFee: deliveryFeeFmt,
      taxaEntrega: deliveryFeeFmt,
      taxa_entrega: deliveryFeeFmt,
      taxa: deliveryFeeFmt,
      discount: discountFmt,
      desconto: discountFmt,
      total: totalFmt,
      totalNum: totalNum,
      totalGeral: totalFmt,
      total_geral: totalFmt,
      totalFmt: totalFmt,

      paymentMethod: paymentMethodStr,
      formaPagamento: paymentMethodStr,
      forma_pagamento: paymentMethodStr,
      pgto: paymentMethodStr,

      changeFor: changeForFmt,
      trocoPara: changeForFmt,
      troco_para: changeForFmt,
      troco: changeForFmt,
